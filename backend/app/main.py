...
# Fully separate feature: own tables (notes/labels/note_labels/saved_views),
# own routes, no shared code paths with articles/highlights above. Deleting
# this section + its schema block in db.py removes the feature cleanly.
